...
@Service public class WeBASEUtils {
    public Dict commonReq(String userAddress,
        ...
        String responseBody = HttpRequest.post("http://localhost:5002/WeBASE-Front/trans/handle").header(Header.CONTENT_TYPE,"application/json").body(dataString).execute().body();
